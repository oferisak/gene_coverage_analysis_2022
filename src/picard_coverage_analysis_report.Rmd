...
picard_analysis_output_folder<-'/media/SSD/Bioinformatics/Projects/gene_coverage_analysis_2022/output/picard_coverage_analysis_2022-04-03-1'
```


```{r render_report,eval=F,echo=F}
library(rmarkdown)
render('/media/SSD/Bioinformatics/Projects/gene_coverage_analysis_2022/src/picard_coverage_analysis_report.Rmd', output_dir = picard_analysis_output_folder,output_file = glue('picard_coverage_report.{Sys.Date()}.html'),quiet = F)
```

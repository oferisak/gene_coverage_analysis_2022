...
#target_region<-'/media/SSD/Bioinformatics/Projects/sequentify_validation_202308/NovaseqR7/targets.hg38.no_info.bed'
#target_region<-'/media/SSD/Bioinformatics/Databases/twist/twist_hg19_exome_comp_spikein_v2.0.2_targets_sorted.re_annotated_0.pad50.bed'
target_region<-'/media/SSD/Bioinformatics/Projects/gene_coverage_analysis_2022/data/target_intervals/HPD_v4_target_hg19.txt.bed'
reference_fasta<-'/media/SSD/Bioinformatics/Databases/dragen/hg19_dragen.fa'
#reference_fasta<-'/media/SSD/Bioinformatics/Databases/hg38/hg38.fa'
...
main_output_folder<-glue('./output/HPD_v4_bam_analysis_{Sys.Date()}')
...
output_folder_to_parse<-main_output_folder
...
for (i in 1:nrow(bam_analysis_def_table)){
  ...
  a_cov_output<-a_cov_output%>%mutate(sample=sample_name,group=group_name)%>%bind_cols(a_mean_cov)
  pt_cov_output<-pt_cov_output%>%mutate(sample=sample_name,group=group_name)%>%left_join(pt_mean_cov)

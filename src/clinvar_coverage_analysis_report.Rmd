...
clinvar_analysis_output_folder<-'/media/SSD/Bioinformatics/Projects/gene_coverage_analysis_2022/output/clinvar_coverage_analysis_2022-04-03/'
...
render('/media/SSD/Bioinformatics/Projects/gene_coverage_analysis_2022/src/clinvar_coverage_analysis_report.Rmd', 
       ...
       output_file = glue('{clinvar_analysis_output_folder}/clinvar_coverage_by_bam_report.{Sys.Date()}.html'),
       quiet = F)
```
...
clinvar_analysis_var_type_per_group<-clinvar_analysis_output%>%group_by(group_name,var_type)%>%
  summarize(across(where(is.numeric),mean))


clinvar_analysis_var_group_per_group<-clinvar_analysis_output%>%group_by(group_name,var_group)%>%
  summarize(across(where(is.numeric),mean))
```

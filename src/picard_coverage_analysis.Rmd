...
main_output_folder<-glue('./output/sequentify_acmg_picard_coverage_analysis_2023-09-03')
...
#target_regions<-c('/media/SSD/Bioinformatics/Projects/sequentify_validation_202308/NovaseqR7/targets.hg38.no_info.bed')
...
reference_fasta<-'/media/SSD/Bioinformatics/Databases/dragen/hg19/hg19_dragen.fa'
reference_dict<-'/media/SSD/Bioinformatics/Databases/dragen/hg19/hg19_dragen.dict'

# reference_fasta<-'/media/SSD/Bioinformatics/Databases/hg38/hg38.fa'
# reference_dict<-'/media/SSD/Bioinformatics/Databases/hg38/hg38.dict'
